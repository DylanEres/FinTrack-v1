...
function App() {
  ...
  useEffect(() => {
    const loadTransactions = () => {
      ...
      try {
        ...
        const storedNextId = localStorage.getItem(STORAGE_KEY + "-nextId");
  ...
  const handleAddTransaction = (e) => {
    ...
    // Create new transaction with local ID
    const transaction = {
      ...newTransaction,
      id: nextId,
    };
  ...
  return (
    <div className="vh-100 d-flex flex-column" style={fullWidthStyle}>
      {/* Simplified header - just centered title */}
      ...
      <main className="flex-grow-1 bg-dark text-white">
        <div className="px-4 py-4 w-100">
              ...
              <div>
                ...
                <div className="progress mb-4" style={{ height: "30px" }}>
                  <div
                    ...
                    style={{
                      width: `${income > 0 ? (balance / income) * 100 : 0}%`,
                    }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      width: `${income > 0 ? (expenses / income) * 100 : 0}%`,
                    }}
                  >
          ...
          {/* Transactions Section - simplified */}
      ...
      {showAddForm && (
        ...
        >
          <div
            className="card bg-dark text-light border border-secondary"
